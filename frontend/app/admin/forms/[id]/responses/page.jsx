...
function FormResponsesInner() {
  ...
  // Below "sm" the table gets cramped fast — default to card view there.
  ...
  const [viewMode, setViewMode] = useState(null); // null until we know screen size
  ...
  // Only set the default view once we know the viewport, and only if the
  // user hasn't already picked one — avoids fighting a manual toggle on
  // window resize.
  useEffect(() => {
    if (viewMode === null) setViewMode(isMobile ? "card" : "table");
  }, [isMobile, viewMode]);

  const previewFields = formMeta?.fields?.slice(0, 2) || [];
          ...
          >
            ...
            >
              <Stack direction={{ xs: "column", sm: "row" }} spacing={{ xs: 0.5, sm: 1.5 }} alignItems={{ xs: "flex-start", sm: "center" }}>
                ...
                >
                  <PeopleAltOutlined
                    sx={{ color: "#7e22ce", fontSize: { xs: 16, sm: 21 } }}
                  />
                </Box>
                ...
                <Box sx={{ minWidth: 0 }}>
                  <Typography
                    ...
                    fontWeight={600}
                    sx={{ fontSize: { xs: "0.55rem", sm: "0.75rem" }, whiteSpace: "nowrap" }}
                  >
                    TOTAL
                  </Typography>
            ...
            >
              <Stack direction={{ xs: "column", sm: "row" }} spacing={{ xs: 0.5, sm: 1.5 }} alignItems={{ xs: "flex-start", sm: "center" }}>
                ...
                >
                  <ScheduleOutlined
                    sx={{ color: "#059669", fontSize: { xs: 16, sm: 21 } }}
                  />
                </Box>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Stack direction="row" spacing={1} alignItems="center" sx={{ alignSelf: { xs: "stretch", sm: "auto" }, justifyContent: "space-between" }}>
                {total > 0 && (
                  <Chip
                    size="small"
          ...
          {loading ? (
            ...
            >
              ...
              >
                Once someone submits this form, their response will appear
                here.
              </Typography>
            </Box>
            ...
            // CARD VIEW — mobile-friendly, one response per card.
            <>
                          ...
                          return (
                            <Box key={f._id} sx={{ minWidth: 0 }}>
                              ...
                              <Typography
                                variant="body2"
                                noWrap
                                sx={{ color: ans?.value ? "#334155" : "#94a3b8", fontWeight: 500 }}
                              >
                                {ans ? String(ans.value) : "—"}
                              </Typography>
                            </Box>
